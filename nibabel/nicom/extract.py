...
the function which takes the DICOM element and returns a dict of meta data.'''
...
class MetaExtractor(object):
    ...
    def __call__(self, dcm):
        ...
        they produce. Values are unchanged unless there is an entry in the 
        object's 'conversions' dict matching the element's value 
        representation (VR).
        '''
        standard_meta = []
